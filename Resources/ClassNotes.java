...
public class ClassNotes extends Notes {

    private JFrame frame = new JFrame("Class Notes Links");
    private Container container;
    private JButton openLinkButton1 = new JButton("C.N." + this.getNoteProviderName1() + " " + this.getNoteProviderID()), openLinkButton2 = new JButton("C.N." + this.getNoteProviderName2() + " " + this.getNoteProviderID());
    private JLabel noteIconLabel;
    private ImageIcon noteIcon;

    public ClassNotes(String noteProviderName, String noteProviderID) {
